    ...
    <div class="tab-main">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item " role="presentation">
                <a class="nav-link search active" id="list-tab" data-toggle="tab" href="#list" role="tab" data-date="{{ $dates['current'] }}" aria-controls="profile" aria-selected="false"><b>一覧</b></a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link " id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true"><b>{{ isset($infoRegister) ? '更新' : ' 申請' }}</b></a>
            </li>
        </ul>
